...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredWithUnavailableOptional() {
    // Have each person have different events. We should see three options because each person has
    // split the restricted times. Optional attendee can't come, so they are ignored
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  public void everyAttendeeIsConsideredWithAvailableOptional() {
    ...
    // split the restricted times. Optional attendee can come, so they are accounted for
  ...
  @Test
  public void onlyOptionalsWithGaps() {
